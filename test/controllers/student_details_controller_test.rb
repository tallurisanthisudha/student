...
class StudentDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_detail" do
    assert_difference("StudentDetail.count") do
      post student_details_url, params: { student_detail: { Branch: @student_detail.Branch, Name: @student_detail.Name, uniq_id: @student_detail.uniq_id } }
    end
  ...
  test "should update student_detail" do
    patch student_detail_url(@student_detail), params: { student_detail: { Branch: @student_detail.Branch, Name: @student_detail.Name, uniq_id: @student_detail.uniq_id } }
